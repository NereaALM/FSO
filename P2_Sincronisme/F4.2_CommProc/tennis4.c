...
//
//	$ gcc tennis4.c winsuport2.o -o tennis4 -lcurses
//  $ gcc pal_ord4.c winsuport2.o -o pal_ord4 -lcurses
//	$ tennis4 fit_param num_pilotes [retard]
//
//	Codis de retorn:
...
int main(int n_args, const char *ll_args[])
{
	...
	{
		fprintf(stderr, "Comanda: tennis4 fit_param num_pilotes [retard]\n");
		exit(1);
	}
